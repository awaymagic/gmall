...
public class SkuAttrValueController {
    ...
    public ResponseVo<List<SaleAttrValueVo>> querySalesAttrValuesBySpuId(@PathVariable("spuId") Long spuId) {
        ...
        List<SaleAttrValueVo> saleAttrValueVos = this.skuAttrValueService.querySalesAttrValuesBySpuId(spuId);
    ...
    public ResponseVo<List<SkuAttrValueEntity>> querySkuAttrValueBySkuId(
        ...
        List<SkuAttrValueEntity> skuAttrValueEntities = this.skuAttrValueService.querySkuAttrValueBySkuId(cid, skuId);
        return ResponseVo.ok(skuAttrValueEntities);
    }
