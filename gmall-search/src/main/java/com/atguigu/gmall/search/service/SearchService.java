...
public class SearchService {
    ...
    private SearchResponseVo parseResult(SearchResponse response) {
        ...
        // 获取聚合结果集中的品牌id聚合
        ParsedLongTerms brandIdAgg = (ParsedLongTerms)aggregations.get("brandIdAgg");// long类型的聚合
    ...
    private SearchSourceBuilder builderDsl(SearchParamVo paramVo) {
        ...
        // 1.构建查询及过滤    http://localhost:18086/search?keyword=%E6%89%8B%E6%9C%BA&brandId=1,2,3&categoryId=225&priceFrom=1000&priceTo=5000&store=true&props=4:8G-12G&props=5:128G-256G
...
//        2.构建排序 http://localhost:18086/search?keyword=%E6%89%8B%E6%9C%BA&brandId=1,2,3&categoryId=225&priceFrom=1000&priceTo=5000&store=true&props=4:8G-12G&props=5:128G-256G&sort=2
...
//        3.分页
        ...
        // 3和4 http://localhost:18086/search?keyword=%E6%89%8B%E6%9C%BA&brandId=1,2,3&categoryId=225&priceFrom=1000&priceTo=5000&store=true&props=4:8G-12G&props=5:128G-256G&sort=2&pageNum=1
//        4.高亮
